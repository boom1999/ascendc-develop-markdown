# Acos<a name="ZH-CN_TOPIC_0000002523304900"></a>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Acos内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetAcosMaxMinTmpSize.md">GetAcosMaxMinTmpSize</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.24000000000001%" headers="mcps1.2.4.1.3 "><p id="p10933112495518"><a name="p10933112495518"></a><a name="p10933112495518"></a>参与计算的元素个数。</p>
</td>
</tr>
</tbody>
</table>
