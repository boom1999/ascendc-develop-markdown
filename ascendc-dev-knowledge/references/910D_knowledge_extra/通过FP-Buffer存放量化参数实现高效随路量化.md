# 通过FP Buffer存放量化参数实现高效随路量化<a name="ZH-CN_TOPIC_0000002554408965"></a>
...
**图 1**  反例数据流图<a name="fig1775910202351"></a>  
![](figures/反例数据流图-59.png "反例数据流图-59")

**图 2**  正例数据流图<a name="fig14909105811118"></a>  
![](figures/正例数据流图-60.png "正例数据流图-60")
