# sqrtf<a name="ZH-CN_TOPIC_0000002554344373"></a>
...
![](figures/zh-cn_formulaimage_0000002554426689.png)
...
```
__simt_vf__ __launch_bounds__(1024) inline void KernelSqrt(__gm__ float* dst, __gm__ float* x)
{
