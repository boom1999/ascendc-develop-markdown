# Lgamma<a name="ZH-CN_TOPIC_0000002554424323"></a>
...
<table><thead align="left"><tr id="zh-cn_topic_0000001698360521_row18755131942614"><th class="cellrowborder" valign="top" width="19.39%" id="mcps1.2.3.1.1"><p id="zh-cn_topic_0000001698360521_p675519193268"><a name="zh-cn_topic_0000001698360521_p675519193268"></a><a name="zh-cn_topic_0000001698360521_p675519193268"></a>参数名</p>
</th>
<th class="cellrowborder" valign="top" width="80.61%" id="mcps1.2.3.1.2"><p id="zh-cn_topic_0000001698360521_p375511918267"><a name="zh-cn_topic_0000001698360521_p375511918267"></a><a name="zh-cn_topic_0000001698360521_p375511918267"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0000001698360521_row14755141911264"><td class="cellrowborder" valign="top" width="19.39%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0000001698360521_p47551198266"><a name="zh-cn_topic_0000001698360521_p47551198266"></a><a name="zh-cn_topic_0000001698360521_p47551198266"></a>T</p>
</td>
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="zh-cn_topic_0000001698360521_p125969172719"><a name="zh-cn_topic_0000001698360521_p125969172719"></a><a name="zh-cn_topic_0000001698360521_p125969172719"></a>操作数的数据类型。</p>
...
<tr id="zh-cn_topic_0000001698360521_row9756719122620"><td class="cellrowborder" valign="top" width="19.39%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0000001698360521_p1682112447268"><a name="zh-cn_topic_0000001698360521_p1682112447268"></a><a name="zh-cn_topic_0000001698360521_p1682112447268"></a>isReuseSource</p>
</td>
...
<p id="p174768308175"><a name="p174768308175"></a><a name="p174768308175"></a>true：开发者允许源操作数被改写，可以使能该参数，使能后本接口内部计算时<strong id="b68501198557"><a name="b68501198557"></a><a name="b68501198557"></a>复用</strong>srcTensor的内存空间，节省部分内存空间；</p>
<p id="p456063318173"><a name="p456063318173"></a><a name="p456063318173"></a>false：本接口内部计算时<strong id="b2850191935517"><a name="b2850191935517"></a><a name="b2850191935517"></a>不复用</strong>srcTensor的内存空间。</p>
...
<tbody><tr id="row98477303196"><td class="cellrowborder" valign="top" width="17.380000000000003%" headers="mcps1.2.4.1.1 "><p id="p15847183018194"><a name="p15847183018194"></a><a name="p15847183018194"></a><strong id="b1284773041918"><a name="b1284773041918"></a><a name="b1284773041918"></a>dstTensor</strong></p>
</td>
...
<tr id="row11848103091920"><td class="cellrowborder" valign="top" width="17.380000000000003%" headers="mcps1.2.4.1.1 "><p id="p58481330191917"><a name="p58481330191917"></a><a name="p58481330191917"></a><strong id="b684803016198"><a name="b684803016198"></a><a name="b684803016198"></a>srcTensor</strong></p>
</td>
...
<tr id="row4848123011192"><td class="cellrowborder" valign="top" width="17.380000000000003%" headers="mcps1.2.4.1.1 "><p id="p1313415271911"><a name="p1313415271911"></a><a name="p1313415271911"></a><strong id="b794718918453"><a name="b794718918453"></a><a name="b794718918453"></a>sharedTmpBuffer</strong></p>
</td>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Lgamma内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetLgammaMaxMinTmpSize.md">GetLgammaMaxMinTmpSize</a>。</p>
</td>
</tr>
<tr id="row216545817417"><td class="cellrowborder" valign="top" width="17.380000000000003%" headers="mcps1.2.4.1.1 "><p id="p1949611581317"><a name="p1949611581317"></a><a name="p1949611581317"></a><strong id="b1086511419200"><a name="b1086511419200"></a><a name="b1086511419200"></a>calCount</strong></p>
</td>
