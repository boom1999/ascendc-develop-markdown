# Asin<a name="ZH-CN_TOPIC_0000002523303814"></a>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Asin内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetAsinMaxMinTmpSize.md">GetAsinMaxMinTmpSize</a>。</p>
</td>
</tr>
<tr id="row260195514316"><td class="cellrowborder" valign="top" width="16.470000000000002%" headers="mcps1.2.4.1.1 "><p id="p1949611581317"><a name="p1949611581317"></a><a name="p1949611581317"></a>calCount</p>
</td>
...
```
输入数据(srcLocal): [ 0.5317103  -0.37912032  0.53408647 ...  0.11059642 -0.67860335]
输出数据(dstLocal): [ 0.56061876 -0.38884547  0.56342685 ...  0.11082313 -0.7458595 ]
```
