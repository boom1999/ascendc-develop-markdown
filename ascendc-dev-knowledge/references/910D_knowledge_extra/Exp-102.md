...
![](figures/zh-cn_formulaimage_0000002554346727.png)

-   设置泰勒展开项数为0，即不使用泰勒展开公式进行计算，公式如下：

    ![](figures/zh-cn_formulaimage_0000002523306800.png)

-   设置泰勒展开项数不为0，即使用泰勒展开公式进行计算，公式如下：

    ![](figures/zh-cn_formulaimage_0000002523346792.png)

    xA<sub>i</sub>代表源操作数的整数部分，该值通过floor\(x\)获取。xB<sub>i</sub>代表源操作数的小数部分。

泰勒展开公式如下：

![](figures/zh-cn_formulaimage_0000002523306798.png)
