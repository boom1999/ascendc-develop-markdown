# 通过BT Buffer实现高效的bias计算<a name="ZH-CN_TOPIC_0000002554408963"></a>
...
**图 1**  反例数据流图<a name="fig1598718171213"></a>  
![](figures/反例数据流图.png "反例数据流图")

**图 2**  正例数据流图<a name="fig12618184193220"></a>  
![](figures/正例数据流图.png "正例数据流图")
