# ExpSub\(ISASI\)<a name="ZH-CN_TOPIC_0000002554424551"></a>
...
![](figures/zh-cn_formulaimage_0000002523346826.png)

源操作数数据类型为half类型时，计算公式如下：

针对Ascend 950PR/Ascend 950DT：

![](figures/zh-cn_formulaimage_0000002523306838.png)
...
<th class="cellrowborder" valign="top" width="81.41000000000001%" id="mcps1.2.3.1.2"><p id="p583535795817"><a name="p583535795817"></a><a name="p583535795817"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="row1835857145817"><td class="cellrowborder" valign="top" width="18.59%" headers="mcps1.2.3.1.1 "><p id="p5835457165816"><a name="p5835457165816"></a><a name="p5835457165816"></a>T</p>
</td>
<td class="cellrowborder" valign="top" width="81.41000000000001%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>目的操作数数据类型。</p>
...
<tr id="row3862230195114"><td class="cellrowborder" valign="top" width="18.59%" headers="mcps1.2.3.1.1 "><p id="p17859630135113"><a name="p17859630135113"></a><a name="p17859630135113"></a>U</p>
</td>
<td class="cellrowborder" valign="top" width="81.41000000000001%" headers="mcps1.2.3.1.2 "><p id="p685914301515"><a name="p685914301515"></a><a name="p685914301515"></a>源操作数数据类型。</p>
<p id="p2060916912719"><a name="p2060916912719"></a><a name="p2060916912719"></a><span id="ph15609179112715"><a name="ph15609179112715"></a><a name="ph15609179112715"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：half、float。</p>
</td>
</tr>
</tbody>
</table>
