# ReduceSum<a name="ZH-CN_TOPIC_0000002523344268"></a>
...
**图 1**  ReduceSum按第一个维度计算示例<a name="fig1757220381044"></a>  
![](figures/ReduceSum按第一个维度计算示例.png "ReduceSum按第一个维度计算示例")

**图 2**  ReduceSum按最后一个维度计算示例<a name="fig7643113101220"></a>  
...
<p id="p122825181523"><a name="p122825181523"></a><a name="p122825181523"></a><span id="ph1928231818522"><a name="ph1928231818522"></a><a name="ph1928231818522"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：int32_t、uint32_t、float、int64_t、uint64_t。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="80.61%" headers="mcps1.2.3.1.2 "><p id="p16565454161520"><a name="p16565454161520"></a><a name="p16565454161520"></a>用于指定ReduceSum计算轴，包括Reduce轴和Normal轴。pattern由与向量维度数量相同的A、R字母组合形成，字母A表示Normal轴，R表示Reduce轴。例如，AR表示对二维向量进行ReduceSum计算：第一维是Normal轴，第二维是Reduce轴，即对第二维进行数据累加的计算。</p>
...
<tr id="row7487197161519"><td class="cellrowborder" valign="top" width="17.380000000000003%" headers="mcps1.2.4.1.1 "><p id="p1313415271911"><a name="p1313415271911"></a><a name="p1313415271911"></a>sharedTmpBuffer</p>
</td>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于ReduceSum内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetReduceSumMaxMinTmpSize.md">GetReduceSumMaxMinTmpSize</a>。</p>
</td>
</tr>
...
<p id="p49281916185816"><a name="p49281916185816"></a><a name="p49281916185816"></a><span id="ph1557703805814"><a name="ph1557703805814"></a><a name="ph1557703805814"></a>Ascend 950PR/Ascend 950DT</span>，当前只支持二维shape。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="72.26%" headers="mcps1.2.4.1.3 "><p id="p184961858133"><a name="p184961858133"></a><a name="p184961858133"></a>表示实际需要计算的最内层轴数据是否32Bytes对齐。</p>
