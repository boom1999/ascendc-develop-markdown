...
-   不带尾块/不带counts参数场景：
    ...
    ![](figures/zh-cn_formulaimage_0000002523346028.png)

    -   方差系数未修正场景：

        ![](figures/zh-cn_formulaimage_0000002554425879.png)

    -   方差系数修正场景：

        ![](figures/zh-cn_formulaimage_0000002554425917.png)

    其中，Mean为均值输出，Var为方差输出。

    Mean<sub>i</sub>代表输入的第i个均值，Var<sub>i</sub>代表输入的第i个方差。Ab代表Reduce轴切分后一次计算的大小，Rn代表Reduce轴按Ab拆分的次数，![](figures/zh-cn_formulaimage_0000002554425885.png)代表未修正的方差系数rRec，![](figures/zh-cn_formulaimage_0000002523345992.png)代表修正方差系数rRecWithCorrection。

-   带尾块/带counts参数场景：

    ![](figures/zh-cn_formulaimage_0000002554425913.png)

    -   方差系数未修正场景：

        ![](figures/zh-cn_formulaimage_0000002554425921.png)

    -   方差系数修正场景：

        ![](figures/zh-cn_formulaimage_0000002554345935.png)

    除上述参数含义外，counts<sub>i</sub>代表Mean<sub>i</sub>对应的系数，R代表未切分的原始Reduce轴长度，![](figures/zh-cn_formulaimage_0000002523346008.png)代表未修正的方差系数rRec，![](figures/zh-cn_formulaimage_0000002554345941.png)代表修正系数rRecWithCorrection。
