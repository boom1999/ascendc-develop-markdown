# Frac<a name="ZH-CN_TOPIC_0000002554423669"></a>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Frac内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetFracMaxMinTmpSize.md">GetFracMaxMinTmpSize</a>。</p>
</td>
</tr>
<tr id="row8503142174218"><td class="cellrowborder" valign="top" width="16.470000000000002%" headers="mcps1.2.4.1.1 "><p id="p15504721154216"><a name="p15504721154216"></a><a name="p15504721154216"></a>calCount</p>
</td>
...
完整的调用样例请参考[Frac样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/03_libraries/00_math/frac)。
