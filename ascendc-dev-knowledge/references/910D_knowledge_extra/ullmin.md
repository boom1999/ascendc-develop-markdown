# ullmin<a name="ZH-CN_TOPIC_0000002523343792"></a>
...
```
__simt_callee__ inline unsigned long long int ullmin(const unsigned long long int x, const unsigned long long int y)
```
