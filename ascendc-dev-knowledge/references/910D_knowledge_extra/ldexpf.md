# ldexpf<a name="ZH-CN_TOPIC_0000002523343888"></a>
...
<td class="cellrowborder" valign="top" width="77.05%" headers="mcps1.2.4.1.3 "><p id="p6389114616514"><a name="p6389114616514"></a><a name="p6389114616514"></a>源操作数，输入数据。</p>
</td>
</tr>
<tr id="row882358163017"><td class="cellrowborder" valign="top" width="11.91%" headers="mcps1.2.4.1.1 "><p id="p108231816305"><a name="p108231816305"></a><a name="p108231816305"></a>exp</p>
</td>
<td class="cellrowborder" valign="top" width="11.04%" headers="mcps1.2.4.1.2 "><p id="p2286191543011"><a name="p2286191543011"></a><a name="p2286191543011"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="77.05%" headers="mcps1.2.4.1.3 "><p id="p8823148153013"><a name="p8823148153013"></a><a name="p8823148153013"></a>源操作数，指数。</p>
</td>
</tr>
</tbody>
</table>
...
-   当x为nan时，返回值为nan。
-   若x \* 2^exp超出float最大范围，返回值为inf。
-   若x \* 2^exp超出float最小范围，返回值为-inf。
