# Sigmoid<a name="ZH-CN_TOPIC_0000002523304766"></a>
...
## 参数说明<a name="section147312297486"></a>
...
<p id="zh-cn_topic_0000001538537601_p2010815466345"><a name="zh-cn_topic_0000001538537601_p2010815466345"></a><a name="zh-cn_topic_0000001538537601_p2010815466345"></a><span id="ph6297112511293"><a name="ph6297112511293"></a><a name="ph6297112511293"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：half、float。</p>
</td>
</tr>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Sigmoid内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p1349516411928"><a name="p1349516411928"></a><a name="p1349516411928"></a>临时空间大小BufferSize的获取方式请参考<a href="GetSigmoidMaxMinTmpSize.md">GetSigmoidMaxMinTmpSize</a>。</p>
</td>
</tr>
...
完整的调用样例请参考[sigmoid样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/03_libraries/02_activation/sigmoid)。
...
// 算子输入的数据类型为float, 需要参与计算的元素个数为512
...
```
输入数据(srcLocal): 
[1.762616 7.9542747 ... 7.8306146 6.3167496]
输出数据(dstLocal): 
