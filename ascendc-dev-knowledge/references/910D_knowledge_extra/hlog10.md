# hlog10<a name="ZH-CN_TOPIC_0000002523304370"></a>
...
![](figures/zh-cn_formulaimage_0000002554346635.png)

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half hlog10(half x)
```

```
__simt_callee__ inline bfloat16_t hlog10(bfloat16_t x)
```
