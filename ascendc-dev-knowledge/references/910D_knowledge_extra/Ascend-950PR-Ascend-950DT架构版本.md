...
-   Channel merge（S8和U8数据类型）
    ...
    ![](figures/Fixpipe_int8-channel_merge.png)
...
-   Channel merge（S4和U4数据类型）：
    ...
    ![](figures/Fixpipe_int4_channel_merge.png)
...
-   FP32 Channel split：
    ...
    ![](figures/Fixpipe_F32_channel_split.png)
