# Mull<a name="ZH-CN_TOPIC_0000002554424067"></a>
...
<td class="cellrowborder" valign="top" width="81.65%" headers="mcps1.2.3.1.2 "><p id="p131047476612"><a name="p131047476612"></a><a name="p131047476612"></a>srcReg0/srcReg1/dstReg为RegTensor类型， 例如RegTensor&lt;uint32_t&gt;，由编译器自动推导，用户不需要填写。</p>
</td>
</tr>
</tbody>
</table>
...
<p id="p9308204584618"><a name="p9308204584618"></a><a name="p9308204584618"></a>类型为<a href="RegTensor.md">RegTensor</a>。</p>
</td>
</tr>
...
__simd_vf__ inline void MullVF(__ubuf__ T* dst0Addr, __ubuf__ T* dst1Addr, __ubuf__ T* src0Addr, __ubuf__ T* src1Addr, uint32_t count, uint32_t oneRepeatSize, uint16_t repeatTimes)
{
    ...
    for (uint16_t i = 0; i < repeatTimes; i++) {
        ...
        AscendC::MicroAPI::Mull(dstReg0, dstReg1, srcReg0, srcReg1, mask);
