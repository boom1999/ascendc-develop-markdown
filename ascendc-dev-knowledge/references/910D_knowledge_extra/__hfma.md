# \_\_hfma<a name="ZH-CN_TOPIC_0000002523303680"></a>
...
![](figures/zh-cn_formulaimage_0000002523345566.png)

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half __hfma(half x, half y, half z)
```

```
__simt_callee__ inline bfloat16_t __hfma(bfloat16_t x, bfloat16_t y, bfloat16_t z)
```
