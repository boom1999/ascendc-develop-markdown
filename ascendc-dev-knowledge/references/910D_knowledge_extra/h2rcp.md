# h2rcp<a name="ZH-CN_TOPIC_0000002554424679"></a>
...
![](figures/zh-cn_formulaimage_0000002554426745.png)

## 函数原型<a name="section620mcpsimp"></a>

```
__simt_callee__ inline half2 h2rcp(half2 x)
```

```
__simt_callee__ inline bfloat16x2_t h2rcp(bfloat16x2_t x)
```
