# asinhf<a name="ZH-CN_TOPIC_0000002554343867"></a>
...
<td class="cellrowborder" valign="top" width="77.05%" headers="mcps1.2.4.1.3 "><p id="p138410291075"><a name="p138410291075"></a><a name="p138410291075"></a>源操作数。</p>
</td>
</tr>
</tbody>
</table>
...
```
template <typename T>
__simt_vf__ __launch_bounds__(1024) inline void KernelAsinh(__gm__ T* dst, __gm__ T* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = asinhf(x[idx]); // 对src源地址的第idx个元素取双曲反正弦值
}
```
