# Atanh<a name="ZH-CN_TOPIC_0000002554424539"></a>
...
<p id="p104071111204211"><a name="p104071111204211"></a><a name="p104071111204211"></a>用于Atanh内部复杂计算时存储中间变量，由开发者提供。</p>
<p id="p5881016172817"><a name="p5881016172817"></a><a name="p5881016172817"></a>临时空间大小BufferSize的获取方式请参考<a href="GetAtanhMaxMinTmpSize.md">GetAtanhMaxMinTmpSize</a>。</p>
</td>
</tr>
...
完整的调用样例请参考[atanh算子样例](https://gitcode.com/cann/asc-devkit/tree/master/examples/03_libraries/00_math/atanh)。
