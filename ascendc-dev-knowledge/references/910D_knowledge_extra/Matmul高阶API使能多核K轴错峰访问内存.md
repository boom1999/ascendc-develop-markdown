...
![](figures/zh-cn_image_0000002554409199.png)

MTE2的搬运效率还可以通过查看其带宽利用率进行验证，如下图所示，通过分析Memory.csv，发现MTE2平均带宽利用率只有34.4%。

![](figures/zh-cn_image_0000002554329227.png)
...
![](figures/zh-cn_image_0000002554409213.png)

MTE2的带宽利用率（Memory.csv）如下所示，平均带宽利用率提升到41.7%。

![](figures/zh-cn_image_0000002523129326.png)
