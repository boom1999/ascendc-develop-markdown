# Neg<a name="ZH-CN_TOPIC_0000002523344556"></a>
...
<p id="p2815124818561"><a name="p2815124818561"></a><a name="p2815124818561"></a><span id="ph148151748205616"><a name="ph148151748205616"></a><a name="ph148151748205616"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：int8_t/int16_t/int32_t/int64_t/half/float</p>
</td>
</tr>
...
<tr id="row19975101518498"><td class="cellrowborder" valign="top" width="18.18%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p>
</td>
 ...
 uint32_t oneRepeatSize, uint16_t repeatTimes)
{
    ...
    for (uint16_t i = 0; i < repeatTimes; i++) {
        ...
        AscendC::MicroAPI::Neg(dstReg, srcReg, mask);
