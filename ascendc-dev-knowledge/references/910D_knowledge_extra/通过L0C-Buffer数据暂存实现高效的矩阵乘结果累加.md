# 通过L0C Buffer数据暂存实现高效的矩阵乘结果累加<a name="ZH-CN_TOPIC_0000002554408993"></a>
...
**图 1**  反例数据流图<a name="fig1739115131882"></a>  
![](figures/反例数据流图-61.png "反例数据流图-61")

**图 2**  正例数据流图<a name="fig1831565712115"></a>  
![](figures/正例数据流图-62.png "正例数据流图-62")
