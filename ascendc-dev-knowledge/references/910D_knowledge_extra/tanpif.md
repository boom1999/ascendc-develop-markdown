# tanpif<a name="ZH-CN_TOPIC_0000002554344657"></a>
...
```
__simt_vf__ __launch_bounds__(1024) inline void KernelTanPi(__gm__ float* dst, __gm__ float* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = tanpif(x[idx]);
}
```
