# ShiftLeft<a name="ZH-CN_TOPIC_0000002554344417"></a>
...
![](figures/zh-cn_formulaimage_0000002523306776.png)
...
<tr id="row1775882311432"><td class="cellrowborder" valign="top" width="14.49%" headers="mcps1.2.3.1.1 "><p id="p248833374113"><a name="p248833374113"></a><a name="p248833374113"></a>U</p>
</td>
...
<p id="p1928341811617"><a name="p1928341811617"></a><a name="p1928341811617"></a><span id="ph1728461819161"><a name="ph1728461819161"></a><a name="ph1728461819161"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：uint8_t/int8_t/uint16_t/int16_t/uint32_t/int32_t/uint64_t/int64_t</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="76%" headers="mcps1.2.4.1.3 "><p id="p053524613153"><a name="p053524613153"></a><a name="p053524613153"></a>左移的位数，数据类型需要与目的操作数Tensor中的元素数据类型保持一致。</p>
<p id="p199311858248"><a name="p199311858248"></a><a name="p199311858248"></a>针对<span id="ph9352334250"><a name="ph9352334250"></a><a name="ph9352334250"></a>Ascend 950PR/Ascend 950DT</span>，scalarValue的取值应大于等于0，如果左移的位数大于src数据类型位宽，dst的全部元素被赋值为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="76%" headers="mcps1.2.4.1.3 "><p id="p5393181792914"><a name="p5393181792914"></a><a name="p5393181792914"></a>重复迭代次数。 矢量计算单元，每次读取连续的256Bytes数据进行计算，为完成对输入数据的处理，必须通过多次迭代（repeat）才能完成所有数据的读取与计算。repeatTime表示迭代的次数。</p>
