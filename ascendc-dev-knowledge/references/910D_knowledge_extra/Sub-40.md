# Sub<a name="ZH-CN_TOPIC_0000002523344160"></a>
...
<p id="p12998112012416"><a name="p12998112012416"></a><a name="p12998112012416"></a><span id="ph1998120152416"><a name="ph1998120152416"></a><a name="ph1998120152416"></a>类型为<a href="RegTensor.md">RegTensor</a>。</span></p>
...
<p id="p15657823142410"><a name="p15657823142410"></a><a name="p15657823142410"></a><span id="ph196571123192418"><a name="ph196571123192418"></a><a name="ph196571123192418"></a>类型为<a href="RegTensor.md">RegTensor</a>。</span></p>
...
__simd_vf__ inline void SubVF(__ubuf__ T* dstAddr, __ubuf__ T* src0Addr, __ubuf__ T* src1Addr, uint32_t count, uint32_t oneRepeatSize, uint16_t repeatTimes)
{
    ...
    for (uint16_t i = 0; i < repeatTimes; i++) {
        ...
        AscendC::MicroAPI::Sub(dstReg, srcReg0, srcReg1, mask);
