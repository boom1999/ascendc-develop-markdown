# Relu<a name="ZH-CN_TOPIC_0000002523303738"></a>
...
<td class="cellrowborder" valign="top" width="81.42%" headers="mcps1.2.3.1.2 "><p id="p168351657155818"><a name="p168351657155818"></a><a name="p168351657155818"></a>操作数数据类型。</p>
<p id="p2366753194920"><a name="p2366753194920"></a><a name="p2366753194920"></a><span id="ph236695334914"><a name="ph236695334914"></a><a name="ph236695334914"></a>Ascend 950PR/Ascend 950DT</span>，支持的数据类型为：int32_t/int64_t/half/float</p>
</td>
</tr>
<tr id="row18835145716587"><td class="cellrowborder" valign="top" width="18.58%" headers="mcps1.2.3.1.1 "><p id="p1756419170189"><a name="p1756419170189"></a><a name="p1756419170189"></a>mode</p>
</td>
<td class="cellrowborder" valign="top" width="81.42%" headers="mcps1.2.3.1.2 "><p id="p1557705555811"><a name="p1557705555811"></a><a name="p1557705555811"></a>选择MERGING模式或ZEROING模式。</p>
<a name="ul195771555135820"></a><a name="ul195771555135820"></a><ul id="ul195771555135820"><li>ZEROING，mask未筛选的元素在dstReg中置零。</li><li>MERGING，当前不支持。</li></ul>
</td>
</tr>
<tr id="row24011032174411"><td class="cellrowborder" valign="top" width="18.58%" headers="mcps1.2.3.1.1 "><p id="p916243141912"><a name="p916243141912"></a><a name="p916243141912"></a>U</p>
</td>
 ...
 uint32_t oneRepeatSize, uint16_t repeatTimes)
{
    ...
    for (uint16_t i = 0; i < repeatTimes; i++) {
        ...
        AscendC::MicroAPI::Relu(dstReg, srcReg, mask);
