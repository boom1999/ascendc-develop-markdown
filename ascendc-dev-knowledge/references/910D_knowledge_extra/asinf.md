# asinf<a name="ZH-CN_TOPIC_0000002554344881"></a>
...
<td class="cellrowborder" valign="top" width="77.05%" headers="mcps1.2.4.1.3 "><p id="p95291217276"><a name="p95291217276"></a><a name="p95291217276"></a>源操作数。</p>
</td>
</tr>
</tbody>
</table>
...
```
__simt_vf__ __launch_bounds__(1024) inline void KernelAsin(__gm__ float* dst, __gm__ float* x)
{
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    dst[idx] = asinf(x[idx]); // 对src源地址的第idx个元素取反正弦值
}
```
