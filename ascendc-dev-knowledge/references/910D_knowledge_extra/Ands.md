# Ands<a name="ZH-CN_TOPIC_0000002554424109"></a>
...
![](figures/zh-cn_formulaimage_0000002554426529.png)
...
<td class="cellrowborder" valign="top" width="86.09%" headers="mcps1.2.3.1.2 "><p id="p499382311404"><a name="p499382311404"></a><a name="p499382311404"></a>类型为BinaryConfig，当标量为LocalTensor单点元素类型时生效，用于指定单点元素操作数位置。默认值DEFAULT_BINARY_CONFIG，表示右操作数为标量。</p>
