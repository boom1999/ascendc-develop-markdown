# 选择低延迟指令，优化归约操作性能<a name="ZH-CN_TOPIC_0000002554409027"></a>
...
## 二分累加方案和归约类指令方案的对比<a name="section179410573522"></a>
...
**图 1**  二分累加方案示意图<a name="fig181871717152010"></a>  
![](figures/二分累加方案示意图.png "二分累加方案示意图")
...
下文给出了二分累加方案和归约类指令方案的核心代码片段和性能数据对比。完整样例请参考[ReduceCustom](https://gitee.com/ascend/samples/tree/master/operator/ascendc/0_introduction/14_reduce_frameworklaunch/ReduceCustom)。
...
<th class="cellrowborder" valign="top" width="50%" id="mcps1.1.3.1.2"><p id="p1788511331538"><a name="p1788511331538"></a><a name="p1788511331538"></a>WholeReduceSum单指令操作</p>
</th>
</tr>
</thead>
<tbody><tr id="row54086232538"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.1 "><p id="p1329224035317"><a name="p1329224035317"></a><a name="p1329224035317"></a>172</p>
</td>
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.1.3.1.2 "><p id="p1129116401539"><a name="p1129116401539"></a><a name="p1129116401539"></a>242</p>
</td>
</tr>
</tbody>
</table>
...
## BlockReduceSum和WholeReduceSum归约方案对比<a name="section18620646762"></a>
...
下文给出了上面三种方式的核心代码片段和性能数据对比。完整样例请参考[ReduceCustom](https://gitee.com/ascend/samples/tree/master/operator/ascendc/0_introduction/14_reduce_frameworklaunch/ReduceCustom)。

【性能数据】

输入shape为256，数据类型为float。如下示例的性能数据如下：

**表 1**  两次WholeReduceSum、三次BlockReduceSum、一次BlockReduceSum加一次WholeReduceSum，三种归约操作的性能数据（循环100次的时间总和）

<a name="table174575114592"></a>
<table><thead align="left"><tr id="row3758185125915"><th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.1"><p id="p57581151175915"><a name="p57581151175915"></a><a name="p57581151175915"></a>两次WholeReduceSum</p>
</th>
<th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.2"><p id="p1960391014012"><a name="p1960391014012"></a><a name="p1960391014012"></a>三次BlockReduceSum</p>
</th>
<th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.3"><p id="p2758451105915"><a name="p2758451105915"></a><a name="p2758451105915"></a>一次BlockReduceSum加一次WholeReduceSum</p>
</th>
</tr>
</thead>
<tbody><tr id="row275855115912"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p075810518599"><a name="p075810518599"></a><a name="p075810518599"></a>13us</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p8758155165918"><a name="p8758155165918"></a><a name="p8758155165918"></a>13.94us</p>
</td>
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p4758165105910"><a name="p4758165105910"></a><a name="p4758165105910"></a>8.44us</p>
</td>
</tr>
</tbody>
</table>
