...
**页面ID:** atlasopapi_07_00779  
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/basicdataapi/atlasopapi_07_00779.html
...
指定ir_index的输入Tensor的offset。当输入ir_index非法或该INPUT没有实例化或该Tensor未携带非连续描述信息时，返回-1。
