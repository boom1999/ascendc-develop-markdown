...
**页面ID:** atlasopapi_07_00563  
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/basicdataapi/atlasopapi_07_00563.html
...
该模板函数用于判断两个数值相乘是否会发生溢出，并在不溢出的情况下返回正确的计算结果。
...
| **lhs** | 输入 | 乘法左操作数。 |
| **rhs** | 输入 | 乘法右操作数。 |
| **ret** | 输入 | 左右操作数相乘的结果，只有函数返回值为true时，该结果才有效。 |
