...
**页面ID:** atlasascendc_api_07_0496  
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/ascendcopapi/atlasascendc_api_07_0496.html
...
![](images/atlasascendc_api_07_0496_img_001.png)

![](images/atlasascendc_api_07_0496_img_002.png)
...
| sharedTmpBuffer | 输入 | 临时缓存。 类型为LocalTensor，支持的TPosition为VECIN/VECCALC/VECOUT。 用于Asin内部复杂计算时存储中间变量，由开发者提供。 临时空间大小BufferSize的获取方式请参考GetAsinMaxMinTmpSize。 |
