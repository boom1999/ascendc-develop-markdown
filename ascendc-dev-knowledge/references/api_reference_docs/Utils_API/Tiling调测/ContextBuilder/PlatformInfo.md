...
**页面ID:** atlasascendc_api_07_1021  
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/ascendcopapi/atlasascendc_api_07_1021.html
...
| 参数 | 输入/输出 | 说明 |
| --- | --- | --- |
| platformInfo | 输入 | 指向fe::PlatFormInfos类型数据的void指针 |
