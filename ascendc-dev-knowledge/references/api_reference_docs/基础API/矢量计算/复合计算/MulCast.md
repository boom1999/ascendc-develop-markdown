...
**页面ID:** atlasascendc_api_07_0049  
**来源:** https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/850/API/ascendcopapi/atlasascendc_api_07_0049.html
...
![](images/atlasascendc_api_07_0049_img_001.png)
...
| 参数名 | 描述 |
| --- | --- |
| T | 目的操作数数据类型。不同数据类型对应的精度转换规则见表3。                       Atlas 推理系列产品            AI Core，支持的数据类型为：int8_t、uint8_t。                       Atlas A2 训练系列产品            /             Atlas A2 推理系列产品            ，支持的数据类型为：int8_t、uint8_t。                       Atlas 200I/500 A2 推理产品            ， 支持的数据类型为：int8_t、uint8_t。 |
| U | 源操作数数据类型。                       Atlas 推理系列产品            AI Core，支持的数据类型为：half。                       Atlas A2 训练系列产品            /             Atlas A2 推理系列产品            ，支持的数据类型为：half。                       Atlas 200I/500 A2 推理产品            ，支持的数据类型为：half。 |
