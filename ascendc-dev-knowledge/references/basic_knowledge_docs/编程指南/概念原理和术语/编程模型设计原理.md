...
![](images/atlas_ascendc_10_00015_img_002.png)

由此可以看出，EnQue/DeQue主要解决了存在数据依赖时，并行执行单元的写后读同步控制问题。

![](images/atlas_ascendc_10_00015_img_003.png)
...
![](images/atlas_ascendc_10_00015_img_004.png)

由此可以看出，AllocTensor/FreeTensor主要解决了存在数据依赖时，并行执行单元的读后写同步控制问题。

![](images/atlas_ascendc_10_00015_img_005.png)
