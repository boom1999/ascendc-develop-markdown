...
![](images/atlas_ascendc_best_practices_10_0043_img_001.png)
...
![](images/atlas_ascendc_best_practices_10_0043_img_002.png)
...
**图1 **计算bound示意图
![](images/atlas_ascendc_best_practices_10_0043_img_006.png)
- 通信bound：

对于同一个切分后的数据块，通信执行耗时大于计算执行耗时，此时，**通信****连续**，且**计算的头块要短**，如下图所示。

**图2 **通信bound示意图
![](images/atlas_ascendc_best_practices_10_0043_img_007.png)
...
![](images/atlas_ascendc_best_practices_10_0043_img_008.png)

![](images/atlas_ascendc_best_practices_10_0043_img_009.png)
