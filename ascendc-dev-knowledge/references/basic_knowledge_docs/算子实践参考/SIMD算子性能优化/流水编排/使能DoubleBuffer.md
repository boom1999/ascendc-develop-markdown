...
**图1 **数据搬运与Vector计算过程
![](images/atlas_ascendc_best_practices_10_0033_img_001.png)**图2 **未使能DoubleBuffer的流水图
...
**图3 **DoubleBuffer机制
![](images/atlas_ascendc_best_practices_10_0033_img_003.png)**图4 **使能DoubleBuffer的流水图
