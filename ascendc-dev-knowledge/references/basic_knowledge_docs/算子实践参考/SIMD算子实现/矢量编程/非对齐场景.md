...
- **非对齐搬入**
       ...
       **图1 **非对齐搬入
![](images/atlas_ascendc_10_0034_img_001.png)
- **非对齐搬出**
...
![](images/atlas_ascendc_10_0034_img_003.png)
...
**图4 **非对齐处理方案示意图
![](images/atlas_ascendc_10_0034_img_004.png)
...
**图5 **冗余数据参与计算
![](images/atlas_ascendc_10_0034_img_005.png)
- 使用mask掩掉冗余数据 
...
**图6 **使用mask掩掉脏数据
![](images/atlas_ascendc_10_0034_img_006.png)
- 通过Duplicate逐行清零。 
...
**图7 **通过Duplicate逐行清零
![](images/atlas_ascendc_10_0034_img_007.png)
...
**图8 **通过Pad一次性清零
![](images/atlas_ascendc_10_0034_img_008.png)
- 使用UnPad接口去除冗余数据后搬出。 
...
![](images/atlas_ascendc_10_0034_img_009.png)
...
![](images/atlas_ascendc_10_0034_img_010.png)
- 带冗余数据搬出 
...
如下图所示，有4个核参与计算，每个核拷贝出4个数，每个核上拷贝的数据长度不满足32字节对齐，采用将冗余数据一起搬出的方式，步骤如下：
  ...
  3. 使用原子累加的方式拷贝到Global，原子累加结合冗余数据清零，确保不会出现数据踩踏。 
       **图11 **带冗余数据搬出
![](images/atlas_ascendc_10_0034_img_011.png)
